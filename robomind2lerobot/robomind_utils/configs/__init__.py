...
from .simulation import Simulation_Config
from .sim_franka_3rgb import Sim_Franka_3RGB_Config
from .franka_fr3_dual_arm import Franka_Fr3_Dual_Arm_Config
from .sim_tienkung_1rgb import Sim_Tienkung_1RGB_Config
...
ROBOMIND_CONFIG = dict(
    ...
    sim_franka_3rgb=Sim_Franka_3RGB_Config,
    franka_fr3_dual=Franka_Fr3_Dual_Arm_Config,
    sim_tienkung_1rgb=Sim_Tienkung_1RGB_Config,
