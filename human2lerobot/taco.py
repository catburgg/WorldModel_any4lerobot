...
class Taco2LeRobot:
    ...
    def process_single_episode(
        ...
        def get_wrist_pose(pose_tensor, trans_tensor): 
            ...
            x, y, z = wrist_pos
            return np.array([x, y, z, r, p, y]).astype(np.float32)
        ...
        for i in range(0, num_frames, extract):
            ...
            frame = {
                ...
                "camera.intrinsic": intrinsic.astype(np.float32),
                "camera.extrinsic": extrinsic[i].astype(np.float32),
...
def parse_args():  # input_root, output_root, fps, repo_id
    ...
    parser.add_argument(
        "--repo_id",
        type=str,
        default="dongyifei/TACO_LeRobot_v2.1",
